      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            ...
            <button onClick={()=>navigate('/lab-tests')} className="inline-flex items-center gap-2 rounded-xl border border-blue-200 bg-white px-7 py-3.5 text-sm font-semibold text-blue-700 transition-all duration-200 hover:bg-blue-50 hover:border-blue-300 active:scale-95">
